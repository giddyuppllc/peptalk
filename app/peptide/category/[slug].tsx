...
export default function CategoryPeptideList() {
  ...
  return (
    <SafeAreaView style={[s.container, { backgroundColor: t.bg }]} edges={['top']}>
      <View style={s.header}>
        <TouchableOpacity onPress={() => { if (router.canGoBack()) router.back(); else router.replace('/(tabs)/my-stacks'); }} style={s.iconBtn} accessibilityRole="button" accessibilityLabel="Go back">
