    ...
    (async () => {
      try {
        ...
        if (prefs.dailyCheckInReminder && prefs.enabled) {
          ...
          // report below. Carried across the Aug/Sep branch split: this fix
          // was made on one machine while the block was being relocated on
          // the other, so a plain merge would have silently dropped it.
