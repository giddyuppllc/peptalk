...
export interface DoseLogEntry {
  ...
  createdAt: string;
  /**
   * §8.8 — when true, this entry was pre-generated by the Calculator's
   * "Schedule cycle" action and represents a *planned* dose for a future
   * (or current) date that the user has not yet confirmed. The Tracker
   * renders planned entries in a ghosted style; the user taps to mark
   * them as taken, which flips this flag.
   */
  planned?: boolean;
}
